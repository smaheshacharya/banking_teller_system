<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loan.aspx.cs" Inherits="FinalProject.services.deposite" %>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <div class="navbar-form navbar-right">
              ...
              <a href="indexuser.aspx" class="btn btn-info"> <span>Loan Deposite</span> </a>
          ...
          <div class="container">
           ...
           <div class="col-lg-6 col-lg-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="lammount" runat="server" CssClass="form-control form-horizontal" TextMode="Number"  ></asp:TextBox>
                    </div>
                </div>
                            </div>
           ...
           <div class="col-lg-6 col-lg-offset-4">
                      ...
                      <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="Loner Name:" CssClass="lable"></asp:Label>
           ...
           <div class="col-lg-3 col-lg-offset-4">
                      ...
                      <div class="form-group">
                        <asp:Label ID="Label3" runat="server" Text="Rate:" CssClass="lable"></asp:Label>
                        <asp:TextBox ID="lrate" runat="server" CssClass="form-control form-horizontal" ></asp:TextBox>
                    </div>
               </div>
             ...
             <div class="col-lg-3">
                      <div class="form-group">
                        <asp:Label ID="Label4" runat="server" Text="Time In year:" CssClass="lable"></asp:Label>
                        <asp:TextBox ID="ltime" runat="server" CssClass="form-control form-horizontal"></asp:TextBox>
                    </div>
