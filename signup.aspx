    ...
    <div class="container">
        ...
        <hr/>
           ...
           <div class="col-lg-6 col-lg-offset-4">
                    ...
                    <div class="form-group">
                         <asp:Label ID="add" runat="server" Text="Address:" CssClass="lable"></asp:Label>
                        <asp:TextBox ID="address" runat="server" CssClass="form-control form-horizontal"  ></asp:TextBox>
                    </div>
                </div>
                    </div>
